...
# ImageAI TinyYOLOv3 modelini yükleme
...
# Dosyanın uygun uzantıya sahip olup olmadığını kontrol etme
...
def gorsel_siniflandirma():
    ...
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            # Görseli ImageAI TinyYOLOv3 ile analiz etme
            ...
            # Model hiçbir nesne tespit etmediyse mesaj gösterme
            if not detections:
